...
void MainFrame::SpecialUpdateIHM()
{
    ...
    else
    {
        ...
        Slider1->Disable();
        MyRadio.SetLevelA( MyRadio.GetReceivedLevelA() ) ;
        Slider2->Disable();
        MyRadio.SetLevelE( MyRadio.GetReceivedLevelE() ) ;
        Slider3->Disable();
        MyRadio.SetLevelR( MyRadio.GetReceivedLevelR() ) ;
        Slider4->Disable();
        MyRadio.SetLevelT( MyRadio.GetReceivedLevelT() ) ;
    }
    ...
    sprintf(tmp_str,"%d",MyRadio.GetReceivedMode());
    StaticText14->SetLabel( tmp_str );
    sprintf(tmp_str,"%d",MyRadio.GetReceivedLevelA());
    StaticText15->SetLabel( tmp_str );
    sprintf(tmp_str,"%d",MyRadio.GetReceivedLevelE());
    StaticText16->SetLabel( tmp_str );
    sprintf(tmp_str,"%d",MyRadio.GetReceivedLevelR());
    StaticText17->SetLabel( tmp_str );
    sprintf(tmp_str,"%d",MyRadio.GetReceivedLevelT());
    StaticText18->SetLabel( tmp_str );
