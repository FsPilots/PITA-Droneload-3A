...
Reglages::Reglages(wxWindow* parent,wxWindowID id)
{
	...
	Create(parent, wxID_ANY, _("Réglage TI Bottom Camera"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
	...
	BoxSizer5->Add(StaticText8, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer6->Add(StaticText10, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer8->Add(StaticText14, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer10->Add(StaticText18, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer12->Add(StaticText22, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer13->Add(StaticText24, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer14->Add(StaticText26, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
{
    char tmpstr[128] ;
    MyPilot.SetPID_P_Up( (double) Slider12->GetValue()/10. ) ;
...
void Reglages::OnPaint(wxPaintEvent& event)
{
	...
	StaticText23->SetLabel( "m_PID_P" ) ;
	sprintf(tmpstr,"%.3f",MyPilot.GetPID_P_Up()) ;
	StaticText24->SetLabel( tmpstr ) ;
	Slider12->SetValue( int (MyPilot.GetPID_P_Up() * 10.) ) ;
}
