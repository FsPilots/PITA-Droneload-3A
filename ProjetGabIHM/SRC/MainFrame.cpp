...
void MainFrame::SpecialUpdateIHM()
{
    ...
    else
    {
        ...
        Slider1->Disable(); MyRadio.SetLevelA( MyRadio.GetReceivedLevelA() ) ;
        Slider2->Disable(); MyRadio.SetLevelE( MyRadio.GetReceivedLevelE() ) ;
        Slider3->Disable(); MyRadio.SetLevelR( MyRadio.GetReceivedLevelR() ) ;
        Slider4->Disable(); MyRadio.SetLevelT( MyRadio.GetReceivedLevelT() ) ;
    }
    Slider1->SetValue( MyRadio.GetLevelA() ) ; sprintf(tmp_str,"%03d",MyRadio.GetLevelA()) ; StaticText10->SetLabel( tmp_str ) ;
    Slider2->SetValue( MyRadio.GetLevelE() ) ; sprintf(tmp_str,"%03d",MyRadio.GetLevelE()) ; StaticText11->SetLabel( tmp_str ) ;
    Slider3->SetValue( MyRadio.GetLevelR() ) ; sprintf(tmp_str,"%03d",MyRadio.GetLevelR()) ; StaticText12->SetLabel( tmp_str ) ;
    Slider4->SetValue( MyRadio.GetLevelT() ) ; sprintf(tmp_str,"%03d",MyRadio.GetLevelT()) ; StaticText13->SetLabel( tmp_str ) ;

    sprintf(tmp_str,"%d",MyRadio.GetTrimA()); StaticText6->SetLabel( tmp_str ) ;
    sprintf(tmp_str,"%d",MyRadio.GetTrimE()); StaticText7->SetLabel( tmp_str ) ;
    sprintf(tmp_str,"%d",MyRadio.GetTrimR()); StaticText8->SetLabel( tmp_str ) ;
    sprintf(tmp_str,"%d",MyRadio.GetTrimT()); StaticText9->SetLabel( tmp_str ) ;

    sprintf(tmp_str,"%d",MyRadio.GetReceivedMode());  StaticText14->SetLabel( tmp_str );
    sprintf(tmp_str,"%d",MyRadio.GetReceivedLevelA());  StaticText15->SetLabel( tmp_str );
    sprintf(tmp_str,"%d",MyRadio.GetReceivedLevelE());  StaticText16->SetLabel( tmp_str );
    sprintf(tmp_str,"%d",MyRadio.GetReceivedLevelR());  StaticText17->SetLabel( tmp_str );
    sprintf(tmp_str,"%d",MyRadio.GetReceivedLevelT());  StaticText18->SetLabel( tmp_str );
